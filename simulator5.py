...
Sales = FCOJ['Sales']
NE = Sales[Sales == 'NE'].index.tolist()[0]
MA = Sales[Sales == 'MA'].index.tolist()[0]
SE = Sales[Sales == 'SE'].index.tolist()[0]
MW = Sales[Sales == 'MW'].index.tolist()[0]
DS = Sales[Sales == 'DS'].index.tolist()[0]
NW = Sales[Sales == 'NW'].index.tolist()[0]
SW = Sales[Sales == 'SW'].index.tolist()[0]
